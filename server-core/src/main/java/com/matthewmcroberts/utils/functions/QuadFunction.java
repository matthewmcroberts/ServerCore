...
public interface QuadFunction<T, U, V, W, R> {
    ...
    @UnknownNullability
    R apply(@UnknownNullability T t, @UnknownNullability U u, @UnknownNullability V v, @UnknownNullability W w);
     ...
     */
    @UnknownNullability
    default <S> QuadFunction<T, U, V, W, S> andThen(@NonNull final Function<? super R, ? extends S> after) {
